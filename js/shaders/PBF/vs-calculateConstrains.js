...
void addToSum(in vec3 particlePosition, in float neighborIndex, out float density, out float sum_k_grad_Ci, out vec3 grad_pi_Ci) {
...
void main() {
    ...
    for(int i = 0; i < 27; i ++) {
        ...
        vec2 voxelsIndex =  (neighborsVoxel.xy + uBucketData.y * vec2(mod(neighborsVoxel.z, uBucketData.z), floor(neighborsVoxel.z / uBucketData.z)) + vec2(0.5)) / uBucketData.x;
